...
export default function App() {
    ...
    const addList = (newElement: List) => {
        const uniqueItem = { ... const uniqueItem = { ...newItem, id: Date.now() }; // Asigna un ID único basado en el tiempo
  return [...list, uniqueItem];, id: Date.now() }; // Asigna un ID único basado en el tiempo
        setList[...list, uniqueItem];
    };
