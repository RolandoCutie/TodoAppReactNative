    ...
    renderTodo = (todo: { name: string; completed: boolean }) => {
        return (
            <View style={styles.todoContainer}>
                <Ionicons name={todo.completed ? "ios-square" : "ios-square-outline"} size={24} color={Colors.gray} style={{ marginRight: 12, width: 32 }} />
                <Text style={[styles.todo, { color: Colors.black }]}>{todo.name}</Text>
            </View>
