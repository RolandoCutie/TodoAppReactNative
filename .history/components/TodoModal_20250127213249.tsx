...
export default class TodoListModal extends React.Component<TodoListModalProps> {
    ...
    addElemntToTodoList = () => {
        let list = this.props.list.todos;
        list.push({ name: this.state.newTodo, completed: false });
        this.props.updateList({ ...this.props.list, todos: list });
            ...
            <KeyboardAvoidingView style={{ flex: 1 }} behavior='padding'>
                <SafeAreaView style={styles.container} >
                    ...
                    <View style={[styles.section, styles.footer]} >
                        ...
                        <TextInput style={[styles.input, { borderColor: list.color }]} placeholder="Enter task" onChange={this.addElemntToTodoList} />
                        <TextInput style={[styles.input, { borderColor: list.color }]} placeholder="Enter task" onChangeText={(text) => this.setState({ newTodo: text })} value={this.state.newTodo} />
