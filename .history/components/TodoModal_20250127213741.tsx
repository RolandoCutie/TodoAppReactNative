...
export default class TodoListModal extends React.Component<TodoListModalProps> {
    ...
    addElemntToTodoList = (element: string) => {
        let list = this.props.list.todos;
        list.push({ name: element, completed: false });
            ...
            <KeyboardAvoidingView style={{ flex: 1 }} behavior='padding'>
                <SafeAreaView style={styles.container} >
                    ...
                    <View style={[styles.section, styles.footer]} >
                        ...
                        <TextInput style={[styles.input, { borderColor: list.color }]} placeholder="Enter task" onChangeText={(text) => this.addElemntToTodoList( newTodo: text })} value={this.state.newTodo} />
