...
export default class TodoListModal extends React.Component<TodoListModalProps> {
    ...
    //Metodo que se encarga primero de adiccionar un nuevo todo a la lista,le genera un id unico a ese todo q es la fecha en q se adicciono y luego lo a;ade a la lista de ese
    addElemntToTodoList = () => {
