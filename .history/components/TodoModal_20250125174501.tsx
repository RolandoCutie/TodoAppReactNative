        ...
        return (
            <SafeAreaView style={styles.container} >
                ...
                <KeyboardAvoidingView style={[styles.section, styles.footer]} behavior="padding">
                    <TextInput style={[styles.imput, { borderColor: list.color }]} placeholder="Enter task" />
                    <TouchableOpacity style={[styles.add, { backgroundColor: list.color }]}></TouchableOpacity>
